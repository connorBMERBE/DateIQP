...
control=cv2.imread("DateIQP\\tutorials\\assets\\blank.jpg") #blank image of tray (control variable)
test=cv2.imread("DateIQP\\tutorials\\assets\\date.jpg") #test image of date on tray
